  ...
  return (
    <div className="relative w-full max-w-[100vw] h-screen overflow-hidden bg-[#faf6ee] text-[#283424] select-none touch-none">
      ...
      >
        ...
        {/* ========================================================================= */}
        {/* SLIDE 05: BORANG RSVP (CARDLESS - DIRECT ON PAPER BACKGROUND)             */}
        {/* ========================================================================= */}
        <SwiperSlide className="relative w-full h-full overflow-hidden flex items-center justify-center">
          <BotanicalWildflowerFrame>
            <div className="flex-1 flex flex-col justify-between items-center py-4 w-full">
              ...
              >
                <span className="font-handwriting text-5xl sm:text-6xl text-[#52664b] block tracking-wide">
                  &lsquo;RSVP&rsquo;
                </span>
                <p className="font-serif text-xs sm:text-sm tracking-wider text-[#697f5f]">
                  Please respond by December 1st, 2026
                </p>
                <p className="font-handwriting text-3xl text-[#3d4d38] pt-1">
                  Kindly Join Our Celebration
                </p>
              </div>
              ...
              {rsvpSubmitted ? (
                ...
                <div 
                  data-swiper-parallax-y="-150"
                  className="p-8 rounded-2xl border border-[#52664b]/20 bg-white/50 text-center space-y-3 my-6 max-w-md w-full"
                >
                  <div className="w-14 h-14 rounded-full bg-[#52664b]/15 text-[#52664b] flex items-center justify-center mx-auto">
                    <CheckCircle2 className="w-8 h-8" />
                  </div>
                  <h3 className="font-serif text-2xl font-bold text-[#222d1f]">
                    Terima Kasih!
                  </h3>
                  <p className="font-serif text-sm sm:text-base text-[#52664b] leading-relaxed">
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-[#52664b] hover:bg-[#44553f] disabled:opacity-50 text-white font-serif text-base font-semibold tracking-wider transition-all shadow-md active:scale-98 flex items-center justify-center gap-2 cursor-pointer mt-3"
                  >
                    {rsvpLoading ? (
